...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      {/* ═══ HERO SECTION ═══ */}
      <section className="relative pt-16 lg:pt-20 pb-8 lg:pb-12 px-4 overflow-hidden">
      ...
      {/* ═══ TRUSTED BY SECTION ═══ */}
      <section className="px-4 pb-16 lg:pb-32 bg-[#FDFDFD]">
        <div className="max-w-6xl mx-auto text-center overflow-hidden w-full relative">
